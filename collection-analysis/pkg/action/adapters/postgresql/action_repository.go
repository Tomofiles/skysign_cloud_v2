		...
		func(comp action.TrajectoryPointComponent) {
			...
			trajectoryPointRecords = append(
				...
				&TrajectoryPoint{
					...
					LatitudeDegree:    comp.GetLatitude(),
					LongitudeDegree:   comp.GetLongitude(),
					AltitudeM:         comp.GetAltitude(),
					RelativeAltitudeM: comp.GetRelativeAltitude(),
					SpeedMS:           comp.GetSpeed(),
					Armed:             comp.GetArmed(),
