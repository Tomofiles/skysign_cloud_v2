		...
		func(comp action.TrajectoryPointComponent) {
			...
			trajectoryPointRecords = append(
				...
				&TrajectoryPoint{
					...
					LatitudeDegree:    comp.GetLatitudeDegree(),
					LongitudeDegree:   comp.GetLongitudeDegree(),
					AltitudeM:         comp.GetAltitudeM(),
					RelativeAltitudeM: comp.GetRelativeAltitudeM(),
					SpeedMS:           comp.GetSpeedMS(),
					Armed:             comp.GetArmed(),
