...
// TestValidateCreateMissionRequest_Failure_Length_FirstLayer .
func TestValidateCreateMissionRequest_Failure_Length_FirstLayer(t *testing.T) {
	a := assert.New(t)
...
// TestValidateCreateMissionRequest_Failure_Length_SecondLayer .
func TestValidateCreateMissionRequest_Failure_Length_SecondLayer(t *testing.T) {
	a := assert.New(t)
