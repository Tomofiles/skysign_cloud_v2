...
func TestCreateNonFleetNewFleet(t *testing.T) {
	...
	fleet := NewInstance(gen, DefaultID, 0)
...
func TestCopyFleet(t *testing.T) {
	...
	fleet := Copy(gen, pub, CopiedID, original)
