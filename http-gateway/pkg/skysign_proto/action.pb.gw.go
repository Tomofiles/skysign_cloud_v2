...
// Note that using this registration option will cause many gRPC library features (such as grpc.SendHeader, etc) to stop working. Consider using RegisterActionServiceHandlerFromEndpoint instead.
...
var (
	pattern_ActionService_GetTrajectory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "actions", "vehicle_id", "trajectory"}, "", runtime.AssumeColonVerbOpt(true)))
)
