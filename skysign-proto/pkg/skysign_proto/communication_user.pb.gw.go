...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterCommunicationUserServiceHandlerFromEndpoint instead.
func RegisterCommunicationUserServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CommunicationUserServiceServer) error {
	...
	mux.Handle("POST", pattern_CommunicationUserService_PushCommand_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PushCommand", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/commands"))
		if err != nil {
	...
	mux.Handle("POST", pattern_CommunicationUserService_PushUploadMission_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PushUploadMission", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/uploadmissions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CommunicationUserService_PullTelemetry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PullTelemetry", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/telemetry"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCommunicationUserServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CommunicationUserServiceClient) error {
	...
	mux.Handle("POST", pattern_CommunicationUserService_PushCommand_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PushCommand", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/commands"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CommunicationUserService_PushUploadMission_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PushUploadMission", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/uploadmissions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CommunicationUserService_PullTelemetry_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.CommunicationUserService/PullTelemetry", runtime.WithHTTPPathPattern("/api/v1/communications/{id}/telemetry"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_CommunicationUserService_PushCommand_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "communications", "id", "commands"}, ""))

	pattern_CommunicationUserService_PushUploadMission_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "communications", "id", "uploadmissions"}, ""))

	pattern_CommunicationUserService_PullTelemetry_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "communications", "id", "telemetry"}, ""))
)
