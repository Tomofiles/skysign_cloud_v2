...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterOperateFlightServiceHandlerFromEndpoint instead.
func RegisterOperateFlightServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OperateFlightServiceServer) error {
	...
	mux.Handle("GET", pattern_OperateFlightService_ListFlightoperations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.OperateFlightService/ListFlightoperations", runtime.WithHTTPPathPattern("/api/v1/flightoperations"))
		if err != nil {
	...
	mux.Handle("GET", pattern_OperateFlightService_GetFlightoperation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.OperateFlightService/GetFlightoperation", runtime.WithHTTPPathPattern("/api/v1/flightoperations/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OperateFlightService_CompleteFlightoperation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/skysign_proto.OperateFlightService/CompleteFlightoperation", runtime.WithHTTPPathPattern("/api/v1/flightoperations/{id}/complete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterOperateFlightServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OperateFlightServiceClient) error {
	...
	mux.Handle("GET", pattern_OperateFlightService_ListFlightoperations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.OperateFlightService/ListFlightoperations", runtime.WithHTTPPathPattern("/api/v1/flightoperations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_OperateFlightService_GetFlightoperation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.OperateFlightService/GetFlightoperation", runtime.WithHTTPPathPattern("/api/v1/flightoperations/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_OperateFlightService_CompleteFlightoperation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/skysign_proto.OperateFlightService/CompleteFlightoperation", runtime.WithHTTPPathPattern("/api/v1/flightoperations/{id}/complete"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_OperateFlightService_ListFlightoperations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "flightoperations"}, ""))

	pattern_OperateFlightService_GetFlightoperation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "flightoperations", "id"}, ""))

	pattern_OperateFlightService_CompleteFlightoperation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "flightoperations", "id", "complete"}, ""))
)
